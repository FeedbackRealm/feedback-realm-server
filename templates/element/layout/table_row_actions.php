...
<div class="btn-group btn-group-sm" role="group">
    <?= $this->Html->link(__('View'), ['controller' => $controller, 'action' => 'view', $entity->id], ['title' => __('View'), 'class' => 'btn btn-outline-info']) ?>
    <?= $this->Html->link(__('Edit'), ['controller' => $controller, 'action' => 'edit', $entity->id], ['title' => __('Edit'), 'class' => 'btn btn-outline-info']) ?>
